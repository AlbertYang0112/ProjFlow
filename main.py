...
if args.graph == 'default':
    ...
    W = weight_matrix(pjoin('./dataset', 'adjDense.csv'))
    data_file = 'featPingSDenseT.csv'
    day_slot = 24
...
PeMS = data_gen(pjoin('./dataset', data_file), (n_train, n_val, n_test), n, n_his + n_pred, day_slot)
